document.getElementById("showTipsBtn").addEventListener("click", function() {
  ...
  const videos = [
    {
      ...
      file: "videos/video1.mp4"  // Replace with the actual path to your video file
    },
    {
      title: "How to Defend Yourself Against an Attacker",
      file: "videos/video2.mp4"  // Replace with the actual path to your video file
    },
    {
      title: "5 Self-Defense Moves Every Woman Should Know",
      file: "videos/video3.mp4"  // Replace with the actual path to your video file
    }
  ];
  ...
  videos.forEach(video => {
    ...
    videoElement.width = 600;  // Adjust the size as needed
